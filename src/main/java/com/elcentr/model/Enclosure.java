...
public class Enclosure extends BaseEntity {
    ...
    public Enclosure(Integer id, String manufacturer, String code, String category, String name,
                     String typeOfInstallation, String color, String material, Integer height, Integer width,
                     Integer depth, Integer indexProtection, String url, String imageUrl) {
        super.setId(id);
